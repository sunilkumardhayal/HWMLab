document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- PEOPLE PAGE LOGIC (UPDATED) ---
    const peopleGrid = document.getElementById('people-grid');
    if (peopleGrid) {
        // This logic now displays members in the exact order of the array above, without grouping.
