document.addEventListener('DOMContentLoaded', () => {
    ...
    const allMembers = [
        ...
        // NOTE: 'indra.webp' for Indrajitsinh Bihola not found in repository. Using a placeholder.
    ...
    if (peopleGrid) {
        ...
        peopleGrid.innerHTML = categoryOrder.map(category => {
            ...
            const displayTitle = categoryDisplayTitles[category]; // Get the display-friendly title
            
            return `
                <div class="col-span-full"><h3 class="text-2xl font-bold mb-6 border-b pb-2 border-gray-300">${displayTitle}</h3></div>
                ${groupedMembers[category].sort((a,b) => a.name.localeCompare(b.name)).map(person => `
